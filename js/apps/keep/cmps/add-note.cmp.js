  ...
  template: `
        <section class="add-note">
            <div class="note-preview" :style="{'background-color': note.color}">
              ...
              <div class="edit-btns ">
                 <span> 
                    <i ref="pin" class="fas fa-thumbtack" @click="togglePinNote" :class="{'pinned': note.isPinned}" style="margin-right:5px;"></i>
  ...
  computed: {
    directions() {
      if (this.note.type === 'text') return 'Insert Plain Text';
        ...
        return 'Type your Todos seperated by commas';
    },
    logoSrc() {
